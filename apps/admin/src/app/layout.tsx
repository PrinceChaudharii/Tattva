...
export const metadata: Metadata = {
  title: {
    default: "Tattva Admin — Dashboard",
    template: "%s | Tattva Admin",
  },
  description: "Administrative dashboard for the Tattva learning platform.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <body className="min-h-screen bg-gray-50 font-sans antialiased">
        ...
        <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-gray-200 bg-white">
          ...
          <nav className="flex-1 space-y-1 overflow-y-auto p-4">
            ...
            <a
              href="/admin"
              className="flex items-center gap-3 rounded-lg bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-700"
            >
              <svg
                className="h-5 w-5"
                fill="none"
